...
#define NUMBER_OF_CURTAIN				1
#define NUMBER_OF_SWITCH				2

#define INDEX_CURTAIN_BASE				3
#define INDEX_SWITCH_BASE				1  //1-2
...
#define AGITABLE_LIFELINE_GROUP_EP1_2 \
{COMMAND_CLASS_SWITCH_BINARY, SWITCH_BINARY_REPORT}

#define AGITABLE_LIFELINE_GROUP_EP3 \
{COMMAND_CLASS_SWITCH_MULTILEVEL, SWITCH_MULTILEVEL_REPORT}
